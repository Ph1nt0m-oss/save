...
def test_register_fresh_email_returns_verification_link():
    ...
    r = requests.post(
        ...
        json={
            ...
            "name": "Iter59 Tester",
            "pseudo": "Iter59 Tester",
            "public_handle": f"iter59_a_{uuid.uuid4().hex[:6]}",
...
def test_resend_verification_returns_link():
    ...
    r0 = requests.post(
        ...
        json={
            ...
            "password": "TestPass1234!",
            "name": "Iter59 Resend",
            "pseudo": "Iter59 Resend",
            "public_handle": f"iter59_r_{uuid.uuid4().hex[:6]}",
            "frontend_url": BASE_URL,
        },
        timeout=20,
    )
...
def test_register_verified_resend_email_link_still_exposed():
    ...
    r = requests.post(
        ...
        json={
            ...
            "name": "Axel",
            "pseudo": "Axel",
            "public_handle": f"axel_{uuid.uuid4().hex[:6]}",
            "frontend_url": BASE_URL,
        },
        timeout=30,
    )
