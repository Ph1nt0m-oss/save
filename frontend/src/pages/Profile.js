...
import { ArrowLeft, Lock, Mail, Download, Trash2, Loader2, AlertTriangle, User as UserIcon } from 'lucide-react';
...
export default function Profile() {
  ...
  const [tab, setTab] = useState('info'); // 'info' | 'password' | 'email' | 'danger'
